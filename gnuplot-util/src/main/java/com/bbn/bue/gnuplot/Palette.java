...
public final class Palette {
   ...
   *
   * Taken from B. Wong, "Points of view: Color blindness" Nature Methods 8:411 (2011) via
  ...
  private static final Palette COLORBLIND_SAFE_7 = Palette.from(ImmutableList.of(
      // black
