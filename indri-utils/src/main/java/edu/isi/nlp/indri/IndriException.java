...
/**
 * Indicates an exception thrown during Indri processing. Be aware that since Indri queries are
 * processed in native code, exceptional situations may occur which will crash the JVM rather than
 * than exception.
 */
