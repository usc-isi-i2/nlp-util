...
/**
 * Specifies a way of running queries against an existing Indri index. If you call this code, the
 * Indri JNI libraries must be in your LD_LIBRARY_PATH or your program will crash.
 */
