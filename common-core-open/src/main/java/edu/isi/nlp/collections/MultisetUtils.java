...
public final class MultisetUtils {
   ...
   */
  public static <T> Multiset<Integer> histogram(
      Multiset<T> data, Comparator<? super Integer> comparator) {
   ...
   */
  public static <T> Iterable<T> elementsOccuringAtLeast(final Multiset<T> data, int minCount) {
  ...
  public static <E> Ordering<Multiset.Entry<E>> byCountDescendingThenItemAscendingOrdering(
      Comparator<? super E> itemComparator) {
