 ...
 * edu.isi.nlp.collections.MapUtils#immutableMapBuilderIgnoringDuplicates()}, {@link
 ...
 * See {@link edu.isi.nlp.collections.LaxImmutableMapBuilder} for more details. </li>
 *
 * <li>Utilities for most major collection types: {@link edu.isi.nlp.collections.CollectionUtils},
 * {@link edu.isi.nlp.collections.IterableUtils}, {@link edu.isi.nlp.collections.IteratorUtils},
 * {@link edu.isi.nlp.collections.ListUtils}, {@link edu.isi.nlp.collections.MapUtils},
 * {@link edu.isi.nlp.collections.MultimapUtils}, {@link edu.isi.nlp.collections.MultisetUtils},
 * {@link edu.isi.nlp.collections.RangeUtils}, {@link edu.isi.nlp.collections.SetUtils},
 * and {@link edu.isi.nlp.collections.TableUtils}.</li>
 *
 * </ul>
 *
