 ...
 *
 * <p>Guava immutable collections generally guarantee that the iteration order is the same as the
 ...
 */
public abstract class ImmutableMultitable<R, C, V> extends AbstractMultitable<R, C, V>
  ...
  @IsiNlpImmutable
  @Value.Immutable
  abstract static class RowKeyColumnKeyPair<R, C> {
  ...
  public interface Builder<R, C, V> {
    ...
    ImmutableMultitable.Builder<R, C, V> putAll(
