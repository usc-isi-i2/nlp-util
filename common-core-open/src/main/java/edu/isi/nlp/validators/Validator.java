...
/**
 * Checks if the supplied argument is valid according to some criterion. If not, throws an
 * exception.
 *
 * @author rgabbard
 */
...
public interface Validator<T> {
  ...
  /**
   * Throws an exception if <code>arg</code> is not valid. Otherwise, does nothing.
   *
