 ...
 *
 * <p>This class can be used with Jackson's converter mechanism to work around this problem by
 * supplying a substitute object for serialization which does not trigger the special key behavior
 * (at some cost to performance/memory...). On the problematic map field, add the following
 ...
 *
 * <p>Please do not use this class for any purpose other than that described above.
 */
public final class MapEntries<K, V> {
  ...
  public static class FromMap
      extends StdConverter<Map<Object, Object>, MapEntries<Object, Object>> {
    @Override
  ...
  public static class ToImmutableMap
      extends StdConverter<MapEntries<Object, Object>, ImmutableMap<Object, Object>> {
    @Override
  ...
  public static class ToImmutableBiMap
      extends StdConverter<MapEntries<Object, Object>, ImmutableBiMap<Object, Object>> {
    @Override
