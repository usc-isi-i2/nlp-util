...
public class AnnotationWrapperModuleTest {
  ...
  public void testWrapSetBindings() {
    ...
    assertEquals(
        ...
        injector.getInstance(Key.get(new TypeLiteral<Set<String>>() {}, Ann1.class)));
    assertEquals(
        ImmutableSet.of("oof", "rab"),
        injector.getInstance(Key.get(new TypeLiteral<Set<String>>() {}, Ann2.class)));
  }
  ...
  public void testWrapMapBindings() {
    ...
    assertEquals(
        ImmutableMap.of("foo", 42.0d, "bar", 24.0d),
        injector.getInstance(Key.get(new TypeLiteral<Map<String, Double>>() {}, Ann1.class)));
    assertEquals(
        ImmutableMap.of("oof", 42.0d, "rab", 24.0d),
        injector.getInstance(Key.get(new TypeLiteral<Map<String, Double>>() {}, Ann2.class)));
  }
  ...
  public void testMultibindings() {
    final Parameters params =
        Parameters.builder()
            .set(
                "one",
                InnerModuleWithSetMultibinding1.class.getName()
                    + ","
    ...
    assertEquals(
        ImmutableSet.of("foo", "bar", "oof", "rab"),
        injector.getInstance(Key.get(new TypeLiteral<Set<String>>() {}, Ann1.class)));
  }
}
