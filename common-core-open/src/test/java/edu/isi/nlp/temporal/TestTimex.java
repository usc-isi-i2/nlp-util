...
public final class TestTimex {
  ...
  static final Timex2Time time19930801at5PM = Timex2Time.builder().withVal("1993-08-01T17:00").build();
  ...
  static final Timex2Time theLastNineMonthsSpanningYear = Timex2Time.builder().withVal("P9M")
      .withAnchorValue("1993-08").withAnchorDirection(BEFORE).build();
  //<TIMEX2 VAL="P9M" ANCHOR_VAL="1993-10" ANCHOR_DIR="BEFORE">the last nine months</TIMEX2>
  static final Timex2Time theLastNineMonthsSameYear = Timex2Time.builder().withVal("P9M")
      .withAnchorValue("1993-10").withAnchorDirection(BEFORE).build();
  // <TIMEX2 SET="YES" PERIODICITY="F1D" GRANULARITY="G1D">daily</TIMEX2>
  static final Timex2Time daily = Timex2Time.builder().withPeriodicity("F1D").withGranularity("G1D").build();
  // <TIMEX2 VAL="P1Y" MOD="LESS_THAN">less than a year</TIMEX2>
  static final Timex2Time lessThanAYear = Timex2Time.builder().withVal("P1Y").withModifier(Modifier.LESS_THAN).build();
  // <TIMEX2 VAL="PXY" ANCHOR_VAL="1993" ANCHOR_DIR="BEFORE">recent
  // years</TIMEX2>
  static final Timex2Time recentYears = Timex2Time.builder().withVal("PXY").withAnchorValue("1993").withAnchorDirection(BEFORE).build();
  ...
  static final Timex2Time mid1992 = Timex2Time.builder().withVal("1992").withModifier(Modifier.MID).build();
  // <TIMEX2 VAL="PRESENT_REF" ANCHOR_VAL="1994-01-21T08:29"
  // ANCHOR_DIR="AS_OF">now</TIMEX2>
  static final Timex2Time nowInstantIn1994 =
      Timex2Time.present().copyBuilder().withAnchorValue("1994-01-21T08:29").withAnchorDirection(AS_OF).build();
  // <TIMEX2 VAL="1994-08-10" MOD="END">late Wednesday</TIMEX2>
  static final Timex2Time lateWednesday = Timex2Time.builder().withVal("1994-08-10").withModifier(Modifier.END).build();
  ...
  static final Timex2Time recently = Timex2Time.past().copyBuilder().withAnchorValue("1995-03-03T06:23").withAnchorDirection(BEFORE).build();
  ...
  // month</TIMEX2>
  static final Timex2Time pastMonth = Timex2Time.builder().withVal("P1M").withAnchorValue("1995-03").withAnchorDirection(BEFORE).build();
  // <TIMEX2 VAL="PRESENT_REF" ANCHOR_VAL="1995-03-09T02:35"
  // ANCHOR_DIR="AS_OF">current</TIMEX2>
  static final Timex2Time current = Timex2Time.present().copyBuilder().withAnchorValue("1995-03-09T02:35").withAnchorDirection(AS_OF).build();
  // <TIMEX2 VAL="1996-11-17T17:07">November 17, 1996 17:07 GMT</TIMEX2>
  static final Timex2Time November1719961707GMT = Timex2Time.builder().withVal("1996-11-17T17:07").build();
  ...
  static final Timex2Time aYear = Timex2Time.builder().withPeriodicity("F1Y").withGranularity("G1Y").build();
  // <TIMEX2 SET="YES" PERIODICITY="F.5M"
  // GRANULARITY="G.5M">twice-monthly</TIMEX2>
  static final Timex2Time twiceMonthly = Timex2Time.builder().withPeriodicity("F.5M").withGranularity("G1Y").build();
