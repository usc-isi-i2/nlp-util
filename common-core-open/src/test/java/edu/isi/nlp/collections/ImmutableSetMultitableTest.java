...
public class ImmutableSetMultitableTest {
  ...
  public void testContainsImmutableSet() {
    ImmutableSetMultitable<Integer, Character, String> table =
        ImmutableSetMultitable.<Integer, Character, String>builder().put(3, 'a', "foo").build();
  ...
  public void values() {
    ...
    // single case
    ImmutableSetMultitable<Integer, Character, String> myTable1 =
        ImmutableSetMultitable.<Integer, Character, String>builder().put(3, 'a', "all").build();
  ...
  public void row() {
    ...
    ImmutableSetMultitable<Integer, Character, String> myTable2 =
        ImmutableSetMultitable.<Integer, Character, String>builder()
            ...
            .build();
    // check rows
    assertEquals(ImmutableSetMultimap.of('a', "all", 'b', "bad"), myTable2.row(3));
  ...
  public void column() {
    ...
    ImmutableSetMultitable<Integer, Character, String> myTable2 =
        ImmutableSetMultitable.<Integer, Character, String>builder()
            ...
            .build();
    // check columns
    assertEquals(ImmutableSetMultimap.of(3, "all"), myTable2.column('a'));
  ...
  private static <R, C, V> ImmutableSetMultitable.SetMulticell<R, C, V> createTestCell(
