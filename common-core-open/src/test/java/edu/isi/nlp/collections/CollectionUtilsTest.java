...
public final class CollectionUtilsTest {
  ...
  public void testPartition() {
    ...
    Assert.assertEquals(
        ImmutableList.of(ImmutableList.of(1, 3), ImmutableList.of(2)),
    ...
    Assert.assertEquals(
        ImmutableList.of(ImmutableList.of(1, 4), ImmutableList.of(2), ImmutableList.of(3)),
        CollectionUtils.partitionAlmostEvenly(ImmutableList.of(1, 2, 3, 4), 3));
    Assert.assertEquals(
        ImmutableList.of(
            ImmutableList.of(1, 2, 3, 10), ImmutableList.of(4, 5, 6), ImmutableList.of(7, 8, 9)),
    ...
    Assert.assertEquals(
        ImmutableList.of(ImmutableList.of(1, 4), ImmutableList.of(2, 5), ImmutableList.of(3)),
  ...
  private final ImmutableList<String> reference =
      ImmutableList.of("hello", "world", "!", "this", "is", "a", "list");
}
