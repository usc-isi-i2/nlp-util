...
public class ImmutableListMultitableTest {
  ...
  public void testContainsImmutableList() {
    ImmutableListMultitable<Integer, Character, String> table =
        ImmutableListMultitable.<Integer, Character, String>builder().put(3, 'a', "foo").build();
  ...
  public void values() {
    ...
    // single case
    ImmutableListMultitable<Integer, Character, String> myTable1 =
        ImmutableListMultitable.<Integer, Character, String>builder().put(3, 'a', "all").build();
  ...
  public void row() {
    ...
    ImmutableListMultitable<Integer, Character, String> myTable2 =
        ImmutableListMultitable.<Integer, Character, String>builder()
            ...
            .build();
    // check rows
    assertEquals(ImmutableListMultimap.of('a', "all", 'b', "bad"), myTable2.row(3));
  ...
  public void column() {
    ...
    ImmutableListMultitable<Integer, Character, String> myTable2 =
        ImmutableListMultitable.<Integer, Character, String>builder()
            ...
            .build();
    // check columns
    assertEquals(ImmutableListMultimap.of(3, "all"), myTable2.column('a'));
    assertEquals(ImmutableListMultimap.of(3, "bad", 4, "bass", 4, "bass"), myTable2.column('b'));
    // check empty
  ...
  private static <R, C, V> ImmutableListMultitable.ListMulticell<R, C, V> createTestCell(
      R row, C column, Iterable<V> valueCollection) {
    final ImmutableListMulticell.Builder<R, C, V> builder =
        new ImmutableListMultitable.ListMulticell.Builder<>();
    return builder.rowKey(row).columnKey(column).addAllValues(valueCollection).build();
  }
