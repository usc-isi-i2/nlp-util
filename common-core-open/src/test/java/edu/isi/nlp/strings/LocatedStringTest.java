...
public final class LocatedStringTest {
  ...
  public void testStartReferenceOffsetsForContentOffset() {
    ...
    assertEquals(CharOffset.asCharOffset(6),
        TEST_STRING1.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(4)).charOffset());
    // location of inserted FACE_WITH_TEARS_OF_JOY
    assertEquals(CharOffset.asCharOffset(8),
        TEST_STRING1.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(7)).charOffset());
    // location of ' replacement
    assertEquals(CharOffset.asCharOffset(0),
        TEST_STRING1.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(0)).charOffset());
  }
  ...
  public void testFromSimpleReferenceString() {
    ...
    for (int i = 0; i < 5; ++i) {
      assertEquals(CharOffset.asCharOffset(i),
  ...
  public void simpleSubstring() {
    ...
    for (int i = 0; i < 5; ++i) {
      assertEquals(ls.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(i)),
    ...
    for (int i = 0; i < 2; ++i) {
      assertEquals(ls.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(3 + i)),
    ...
    for (int i = 0; i < 3; ++i) {
      assertEquals(ls.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(1 + i)),
