...
import static edu.isi.nlp.StringUtils.unicodeFriendly;
import static edu.isi.nlp.strings.offsets.OffsetGroup.fromMatchingCharAndEDT;
...
public final class LocatedStringTest {
  ...
  private static final UnicodeFriendlyString TEST1_CONTENT =
      unicodeFriendly("'lo " + CHEESE_WEDGE + ", " + FACE_WITH_TEARS_OF_JOY + " how are you?");

  private static final LocatedString TEST_STRING1 =
      new LocatedString.Builder()
          ...
          .addCharacterRegions(
              ...
              new LocatedString.CharacterRegion.Builder()
                  ...
                  .contentEndPosExclusive(CharOffset.asCharOffset(1))
              ...
              new LocatedString.CharacterRegion.Builder()
                  .contentNonBmp(false)
                  .contentStartPosInclusive(CharOffset.asCharOffset(1))
                  .contentEndPosExclusive(CharOffset.asCharOffset(4))
              ...
              new LocatedString.CharacterRegion.Builder()
                  .contentNonBmp(true)
                  .contentStartPosInclusive(CharOffset.asCharOffset(4))
                  .contentEndPosExclusive(CharOffset.asCharOffset(5))
              ...
              new LocatedString.CharacterRegion.Builder()
                  .contentNonBmp(false)
                  .contentStartPosInclusive(CharOffset.asCharOffset(5))
                  .contentEndPosExclusive(CharOffset.asCharOffset(7))
              ...
              new LocatedString.CharacterRegion.Builder()
                  .contentNonBmp(true)
                  .contentStartPosInclusive(CharOffset.asCharOffset(7))
                  .contentEndPosExclusive(CharOffset.asCharOffset(8))
              ...
              new LocatedString.CharacterRegion.Builder()
                  .contentNonBmp(false)
                  .contentStartPosInclusive(CharOffset.asCharOffset(8))
                  .contentEndPosExclusive(CharOffset.asCharOffset(9))
                  .referenceStartOffsetInclusive(fromMatchingCharAndEDT(8))
                  .referenceEndOffsetInclusive(fromMatchingCharAndEDT(8))
                  .build(),
              ...
              new LocatedString.CharacterRegion.Builder()
                  .contentNonBmp(false)
                  .contentStartPosInclusive(CharOffset.asCharOffset(9))
                  .contentEndPosExclusive(CharOffset.asCharOffset(21))
  ...
  public void testStartReferenceOffsetsForContentOffset() {
    ...
    assertEquals(
        ...
        TEST_STRING1
            .startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(4))
            .charOffset());
    // location of inserted FACE_WITH_TEARS_OF_JOY
    assertEquals(
        CharOffset.asCharOffset(8),
        TEST_STRING1
            .startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(7))
            .charOffset());
    // location of ' replacement
    assertEquals(
        CharOffset.asCharOffset(0),
        TEST_STRING1
            .startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(0))
            .charOffset());
  }
  ...
  public void testEndReferenceOffsetsForContentOffset() {
    ...
    assertEquals(
        CharOffset.asCharOffset(6),
        TEST_STRING1.endReferenceOffsetsForContentOffset(CharOffset.asCharOffset(4)).charOffset());
    // location of inserted FACE_WITH_TEARS_OF_JOY
    assertEquals(
        CharOffset.asCharOffset(8),
        TEST_STRING1.endReferenceOffsetsForContentOffset(CharOffset.asCharOffset(7)).charOffset());
    // location of ' replacement
    assertEquals(
        CharOffset.asCharOffset(0),
        TEST_STRING1.endReferenceOffsetsForContentOffset(CharOffset.asCharOffset(0)).charOffset());
  }

  private static final LocatedString INITIAL_SUBSTRING1 =
      new LocatedString.Builder()
          .referenceString(TEST1_REFERENCE)
          ...
          .addCharacterRegions(
              ...
              new LocatedString.CharacterRegion.Builder()
                  .contentNonBmp(false)
                  .contentStartPosInclusive(CharOffset.asCharOffset(5))
                  .contentEndPosExclusive(CharOffset.asCharOffset(6))
                  .referenceStartOffsetInclusive(fromMatchingCharAndEDT(7))
  ...
  private static final LocatedString FINAL_SUBSTRING1 =
      new LocatedString.Builder()
          .referenceString(TEST1_REFERENCE)
          ...
          .addCharacterRegions(
              ...
              new LocatedString.CharacterRegion.Builder()
                  .contentNonBmp(true)
                  .contentStartPosInclusive(CharOffset.asCharOffset(1))
                  .contentEndPosExclusive(CharOffset.asCharOffset(2))
                  .referenceStartOffsetInclusive(fromMatchingCharAndEDT(8))
                  .referenceEndOffsetInclusive(fromMatchingCharAndEDT(8))
                  .build(),
              // space insertion
              new LocatedString.CharacterRegion.Builder()
                  .contentNonBmp(false)
                  .contentStartPosInclusive(CharOffset.asCharOffset(2))
                  .contentEndPosExclusive(CharOffset.asCharOffset(3))
                  .referenceStartOffsetInclusive(fromMatchingCharAndEDT(8))
                  .referenceEndOffsetInclusive(fromMatchingCharAndEDT(8))
                  .build(),
              // remainder of the string, unchanged
              new LocatedString.CharacterRegion.Builder()
                  .contentNonBmp(false)
                  .contentStartPosInclusive(CharOffset.asCharOffset(3))
                  .contentEndPosExclusive(CharOffset.asCharOffset(15))
                  .referenceStartOffsetInclusive(fromMatchingCharAndEDT(9))
                  .referenceEndOffsetInclusive(fromMatchingCharAndEDT(20))
                  .build())
          .build();
  ...
  private static final LocatedString SPLIT_REGIONS_ON_BOTH_ENDS_SUBSTRING1 =
      new LocatedString.Builder()
          .referenceString(TEST1_REFERENCE)
          .content(unicodeFriendly("o " + CHEESE_WEDGE + ", " + FACE_WITH_TEARS_OF_JOY + " how "))
          .addCharacterRegions(
              ...
              new LocatedString.CharacterRegion.Builder()
                  .contentNonBmp(false)
                  .contentStartPosInclusive(CharOffset.asCharOffset(6))
                  .contentEndPosExclusive(CharOffset.asCharOffset(7))
                  .referenceStartOffsetInclusive(fromMatchingCharAndEDT(8))
                  .referenceEndOffsetInclusive(fromMatchingCharAndEDT(8))
                  .build(),
              ...
              new LocatedString.CharacterRegion.Builder()
                  .contentNonBmp(false)
                  .contentStartPosInclusive(CharOffset.asCharOffset(7))
                  .contentEndPosExclusive(CharOffset.asCharOffset(11))
                  .referenceStartOffsetInclusive(fromMatchingCharAndEDT(9))
  ...
  private static final LocatedString SINGLE_REGION_SUBSTRING1 =
      new LocatedString.Builder()
          .referenceString(TEST1_REFERENCE)
  ...
  public void testContentLocatedSubstringByContentOffsets() {
    ...
    assertEquals(
        INITIAL_SUBSTRING1,
        TEST_STRING1.contentLocatedSubstringByContentOffsets(OffsetRange.charOffsetRange(0, 5)));
    // substring from middle to end, splitting initial character region
    assertEquals(
        FINAL_SUBSTRING1,
        TEST_STRING1.contentLocatedSubstringByContentOffsets(OffsetRange.charOffsetRange(6, 20)));
    // substring splitting regions on both ends
    assertEquals(
        SPLIT_REGIONS_ON_BOTH_ENDS_SUBSTRING1,
        TEST_STRING1.contentLocatedSubstringByContentOffsets(OffsetRange.charOffsetRange(2, 12)));
    // substring which is a single region
    assertEquals(
        SINGLE_REGION_SUBSTRING1,
  ...
  public void testFromSimpleReferenceString() {
    ...
    for (int i = 0; i < 5; ++i) {
      assertEquals(
          CharOffset.asCharOffset(i),
          ls.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(i)).charOffset());
    }
  }
  ...
  public void testReferenceSubstringByContentOffsets() {
    // substring from the beginning, splitting the final character region
    assertEquals(
        INITIAL_SUBSTRING_REF_STRING,
        TEST_STRING1.referenceSubstringByContentOffsets(OffsetRange.charOffsetRange(0, 5)).get());
    // substring from middle to end, splitting initial character region
    assertEquals(
        FINAL_SUBSTRING_REF_STRING,
        TEST_STRING1.referenceSubstringByContentOffsets(OffsetRange.charOffsetRange(6, 20)).get());
    // substring splitting regions on both ends
    assertEquals(
        SPLIT_REGION_ON_BOTH_ENDS_REF_STRING,
        TEST_STRING1.referenceSubstringByContentOffsets(OffsetRange.charOffsetRange(2, 12)).get());
    // substring which is a single region
    assertEquals(
        SINGLE_REGION_REFERENCE_STRING,
  ...
  public void simpleSubstring() {
    ...
    final LocatedString hello =
        ls.contentLocatedSubstringByContentOffsets(
    ...
    for (int i = 0; i < 5; ++i) {
      assertEquals(
          ls.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(i)),
          hello.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(i)));
    }
    ...
    for (int i = 0; i < 3; ++i) {
      assertEquals(
          ls.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(i)),
          hel.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(i)));
    }
    ...
    for (int i = 0; i < 2; ++i) {
      assertEquals(
          ls.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(3 + i)),
          lo.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(i)));
    }
    ...
    for (int i = 0; i < 3; ++i) {
      assertEquals(
          ls.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(1 + i)),
          ell.startReferenceOffsetsForContentOffset(CharOffset.asCharOffset(i)));
    }
  }
  ...
  public void testSubstringMappingContentMismatchBug() {
    ...
    final LocatedString trueContainee =
        new LocatedString.Builder()
            ...
            .addCharacterRegions(
                new LocatedString.CharacterRegion.Builder()
                    ...
                    .referenceEndOffsetInclusive(OffsetGroup.fromMatchingCharAndEDT(4))
                    .build())
            .build();
    final LocatedString spuriousContainee =
        new LocatedString.Builder()
            .content(unicodeFriendly("de"))
            .referenceString(container.referenceString())
            .addCharacterRegions(
                new LocatedString.CharacterRegion.Builder()
                    ...
                    .referenceEndOffsetInclusive(OffsetGroup.fromMatchingCharAndEDT(1))
                    .build())
            .build();
