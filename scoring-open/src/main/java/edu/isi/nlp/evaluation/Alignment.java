 ...
 * {@code test} set. Alignments are intended to be immutable, so it is always safe to case an {@code
 * Alignment<T>} to {@code Alignment<S>} for any super-type of {@code T}.
 *
 * <p>The objects being aligned must have hash codes and equality methods compatible with use in
 * sets and maps.
 *
