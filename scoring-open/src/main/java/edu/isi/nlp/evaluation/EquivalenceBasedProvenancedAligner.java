...
public final class EquivalenceBasedProvenancedAligner<LeftT, RightT, EqClassT>
  ...
  /**
   * Creates an aligner given a single function from items to equivalence classes (requires left and
   * right items to both be of types compatible with this function).
   */
  public static <InT, EqClass>
      EquivalenceBasedProvenancedAligner<InT, InT, EqClass> forEquivalenceFunction(
          Function<? super InT, ? extends EqClass> equivalenceFunction) {
    return new EquivalenceBasedProvenancedAligner<InT, InT, EqClass>(
        (Function<InT, EqClass>) equivalenceFunction, (Function<InT, EqClass>) equivalenceFunction);
  }
   ...
   */
  public static <LeftT, RightT, EqClass>
      EquivalenceBasedProvenancedAligner<LeftT, RightT, EqClass> forKeyAndTestEquivalenceFunctions(
  ...
  public EquivalenceBasedProvenancedAlignment<EqClassT, LeftT, RightT> align(
      Iterable<? extends LeftT> left, Iterable<? extends RightT> right) {
    final ImmutableListMultimap<? extends EqClassT, ? extends LeftT>
        leftEquivalenceClassToProvenance = Multimaps.index(left, leftEqClassFunction);
    final ImmutableListMultimap<? extends EqClassT, ? extends RightT>
        rightEquivalenceClassToProvenance = Multimaps.index(right, rightEqClassFunction);
  ...
  @Override
  public Function<
          EvalPair<? extends Iterable<? extends LeftT>, ? extends Iterable<? extends RightT>>,
          ProvenancedAlignment<EqClassT, LeftT, EqClassT, RightT>>
      asFunction() {
    return new Function<
        EvalPair<? extends Iterable<? extends LeftT>, ? extends Iterable<? extends RightT>>,
        ProvenancedAlignment<EqClassT, LeftT, EqClassT, RightT>>() {
      @Override
      public ProvenancedAlignment<EqClassT, LeftT, EqClassT, RightT> apply(
          final EvalPair<? extends Iterable<? extends LeftT>, ? extends Iterable<? extends RightT>>
              input) {
